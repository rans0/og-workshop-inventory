...
export default function Dashboard() {
  ...
  return (
    <main className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6 sm:space-y-8 pb-12">
      ...
      {/* Recently Updated - Mobile Optimized with Click Actions */}
            ...
            return (
              ...
              >
                <div className="min-w-0 flex-1 mr-3">
                  <p className="font-bold text-sm sm:text-lg truncate">{item?.name || 'Barang Terhapus'}</p>
      ...
      {/* Quick Action Modal */}
      {selectedItem && (
        <QuickActionModal item={selectedItem} onClose={() => setSelectedItem(null)} />
      )}
    </main>
  );
}
